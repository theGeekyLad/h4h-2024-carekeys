...
import com.blacklotus.carekeys.latin.common.UnicodeSurrogate;
import com.blacklotus.carekeys.latin.settings.SpacingAndPunctuations;
import com.blacklotus.carekeys.latin.utils.CapsModeUtils;
import com.blacklotus.carekeys.latin.utils.DebugLogUtils;
    ...
    public void commitText(final CharSequence text, final int newCursorPosition) {
        ...
        if (isConnected()) {
            ...
            for (final CharacterStyle span : spans) {
                ...
                // See com.blacklotus.carekeys.latin.common.Constants.UnicodeSurrogate
